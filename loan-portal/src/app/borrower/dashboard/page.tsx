    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <header className="bg-white border-b shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">My Financing</h1>
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">No Financing Yet</h3>
              <p className="text-slate-600 mb-6">
                Start your home journey by applying for interest-free financing.
              </p>
              <Button className="bg-blue-600 hover:bg-blue-700">
                Apply for Financing
              </Button>
              ...
              <Card className="border-2 border-blue-500 shadow-lg">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-xl">Active Financing</CardTitle>
                      <p className="text-sm text-slate-600 mt-1">
                        Home: {(activeLoan as any).property_address || "Not specified"}
                      </p>
                    </div>
